  ...
  <el-dialog title="Secondary files and metadata" :visible.sync="dialogFormVisible" class="el-dialog-dark">
    <el-form @submit.native.prevent>
      <div class="form-group">
        ...
        <div v-for="(group, idx) of controls" :key="idx" class="mb-1r el-input el-input-group el-input-group--append">
          ...
          <span class="el-input-group__append" style="background: transparent; border: none">
            <button
              :disabled="readonly"
              type="button"
              class="pointer el-button--text"
              @click="deleteSecondaryFile(idx)"
            >
        ...
        <div>
          <el-button type="text" size="mini" @click="addSecondaryFile('', 'File')">
            <i class="el-icon-plus"></i> Add a file
          </el-button>
