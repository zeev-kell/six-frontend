    ...
    <div class="error-page">
      ...
      >
        ...
        <g fill="none" fill-rule="evenodd">
          <path fill="#FFF" d="M0 0H1366V800H0z" transform="translate(-448 -158)"></path>
          <g>
      ...
      <h1 class="error-title">Woops!<br />出了点问题：(</h1>
      <h2 class="error-subtitle">你试过把它关掉再打开吗？</h2>
    </div>
  </div>
</template>
